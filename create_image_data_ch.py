...
def clip_words(text: str, font: ImageFont.ImageFont, limit: int):
    ...
    if limit >= width:
        ...
        width_你好 = font.getbbox("你好")[2] - font.getbbox("你好")[0]
        width_你 = font.getbbox("你")[2] - font.getbbox("你")[0]
        width_per_word = max(width_你好 - width_你, 1)
        word_per_line = max(limit // width_per_word, 1)
